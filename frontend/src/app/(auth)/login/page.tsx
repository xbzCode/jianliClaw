            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  type="email"
                  placeholder="请输入邮箱"
                  className="h-8 w-full min-w-0 rounded-lg border border-input bg-transparent pl-9 pr-2.5 py-1 text-base transition-colors outline-none placeholder:text-muted-foreground focus-visible:border-ring focus-visible:ring-3 focus-visible:ring-ring/50 md:text-sm dark:bg-input/30"
                  {...register('email')}
                />
              </div>
              {errors.email && (
